            ...
            <header className="flex justify-between items-start pb-4 border-b">
                ...
                <div className="text-right">
                    ...
                    <div className="mt-2 text-xs">
                        ...
                        <p className="flex justify-end gap-2"><span className="text-slate-500">Date Issued:</span> <span className="font-semibold">{new Date(createdDate).toLocaleDateString()}</span></p>
                        <p className="flex justify-end gap-2"><span className="text-slate-500">Expected By:</span> <span className="font-semibold">{new Date(expectedDate).toLocaleDateString()}</span></p>
                    </div>
                </div>
            </header>
