                ...
                <header className="flex justify-between items-start pb-4 border-b">
                    ...
                    <div className="text-right">
                        ...
                        <div className="mt-2 text-xs">
                            ...
                            <p className="flex justify-end gap-2"><span className="text-slate-500">Invoice Date:</span> <span className="font-semibold">{new Date(invoice.invoiceDate).toLocaleDateString()}</span></p>
                            <p className="flex justify-end gap-2"><span className="text-slate-500">Due Date:</span> <span className="font-semibold">{new Date(invoice.dueDate).toLocaleDateString()}</span></p>
                        </div>
                    </div>
                </header>
